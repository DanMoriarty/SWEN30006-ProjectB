...
/**
 * A program for simulating the Melbourne Metropolitan Rail System.
 * Creates and Renders the simulation within a Gradle framework
 * @version 2
 */
public class MetroMadness extends ApplicationAdapter {
	...
	/**
	 * Processes user input to control Simulation
	 */
