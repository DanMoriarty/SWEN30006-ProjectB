...
/**
 * Responsible for running the Melbourne Metro simulation.
 * Contains necessary simulation methods and Melbourne Metro elements, 
 * including trains, lines, and stations
 */
public class Simulation {
	...
	/**
	 * Renders all lines, trains, and stations of the simulations
	 * @param renderer the specific renderer to use
	 */
